...
async function checkWeather(city){
   ...
   document.querySelector(".val1").innerHTML = data.main.pressure + " hpa";
   document.querySelector(".val2").innerHTML = data.clouds.all +"%" ;
   document.querySelector(".val3").innerHTML = data.main.temp_max +" °C" ;
